...
gulp.task('generate', () => {
  ...
  symfony.getResourcesInUse(argument, (err, resources) => {
    util.askFiles(util.resourceArray(resources.js, 'path'), 'Select JS to concat and minify', cssResults => {
      util.askFiles(util.resourceArray(resources.css, 'path'), 'Select CSS to concat and minify', jsResults => {
